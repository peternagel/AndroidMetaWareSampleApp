 ...
 */
public class SensorConfigAdapter extends ArrayAdapter<SensorConfig> {
    public SensorConfigAdapter(Context context, int resource) {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        final SensorConfig current= getItem(position);
